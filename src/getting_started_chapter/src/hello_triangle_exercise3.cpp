...
int main()
{
    ...
    // check for orange shader compile errors
    ...
    // link one and only vertex shader and Orange fragment shader
    int shaderProgramOrange = glCreateProgram();
    glAttachShader(shaderProgramOrange, vertexShader);
    glAttachShader(shaderProgramOrange, fragmentShaderOrange);
    glLinkProgram(shaderProgramOrange);
    // check for linking errors for vertex shader and Orange fragment shader
    ...
    // link one and only vertex shader and Yellow fragment shader
    int shaderProgramYellow = glCreateProgram();
    glAttachShader(shaderProgramYellow, vertexShader);
    glAttachShader(shaderProgramYellow, fragmentShaderYellow);
    glLinkProgram(shaderProgramYellow);
    // check for linking errors for vertex shader and Yellow fragment shader
    ...
    // we are using 2 VAO's and 2 VBO's and not indexed EBO
    unsigned int VBO[2], VAO[2];
    glGenVertexArrays(2, VAO);
    glGenBuffers(2, VBO);
    
    // first traingle setup
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        // draw our first triangle using data from first VAO and Orange Shader
        glUseProgram(shaderProgramOrange);
        glBindVertexArray(VAO[0]);
        glDrawArrays(GL_TRIANGLES, 0, 3);

        // draw our first triangle using data from first VAO and Yellow Shader
